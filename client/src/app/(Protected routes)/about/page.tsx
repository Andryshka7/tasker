	...
	return (
		<div className='mx-10 flex flex-col items-center'>
			...
			<p className='line mt-8 max-w-[1050px] text-center text-xl font-medium leading-10'>
				...
				enhance productivity within teams. Whether you're working on a small project or
				managing complex workflows across multiple teams, Tasker empowers you to stay
				organized, prioritize tasks, and track progress with ease.
			</p>
